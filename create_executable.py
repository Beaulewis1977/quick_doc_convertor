...
def main():
    ...
    if create_executable():
        ...
        if exe_file.exists():
            ...
            response = (
                input("\nCreate desktop shortcut for the executable? (y/n): ")
                .lower()
                .strip()
            )
            if response in ["y", "yes"]:
                try:
                    ...
                    shortcut.Description = (
                        "Quick Document Convertor - Standalone Executable"
                    )
                    shortcut.save()
                    ...
                    print(
                        "You can manually create a shortcut by right-clicking the .exe file"
                    )
