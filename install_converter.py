...
def install_packages():
    ...
    packages = ["python-docx", "PyPDF2", "tkinterdnd2", "winshell", "pywin32"]
...
def create_desktop_shortcut():
    ...
    try:
        ...
        target = os.path.abspath(
            os.path.join(os.path.dirname(__file__), "run_converter.bat")
        )
        wDir = os.getcwd()
        icon = target
...
def create_start_menu_shortcut():
    ...
    try:
        ...
        files_to_copy = ["document_converter_gui.py", "run_converter.bat"]
