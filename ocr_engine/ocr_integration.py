...
class OCRIntegration:
    ...
    def check_availability(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "supported_formats": list(
                OCRFormatDetector.get_supported_extensions()
            ),
        }
    ...
    def _process_single_file(
        self, file_path: str, output_dir: str, output_format: str
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            output_filename = file_path.stem + self._get_extension(
                output_format
            )
            output_path = output_dir / output_filename

            # Save result
            success = self.ocr_engine.save_result(
                result, str(output_path), output_format
            )
    ...
    def _get_extension(self, format_type: str) -> str:
        ...
        extensions = {"txt": ".txt", "json": ".json", "markdown": ".md"}
