...
# Add a label
label = tk.Label(
    root, text="Quick Document Converter Test", font=("Arial", 12)
)
label.pack(pady=20)

# Add a button
button = tk.Button(
    root, text="Click Me!", command=test_function, font=("Arial", 10)
)
button.pack(pady=10)

# Add status
status = tk.Label(
    root, text="If you see this, tkinter is working!", fg="green"
)
status.pack(pady=10)
